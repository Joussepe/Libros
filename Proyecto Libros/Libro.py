class Libro:
    def __init__(self, titulo, autor, año_publicacion):
        self.titulo = titulo
        self.autor = autor
        if not isinstance(año_publicacion, int) or año_publicacion < 999:
            raise ValueError("El formato de año debe ser yyyy.")
...
class Biblioteca:
    ...
    def agregar_libro(self, libro):
        ...
        for lib in self.libros:
            if lib.titulo.lower() == libro.titulo.lower():
...
class ErrorLibroDuplicado(Exception):
    def __init__(self, mensaje="El libro ya está en la biblioteca."):
        self.mensaje = mensaje
        super().__init__(self.mensaje)

class ErrorAñoInvalido(Exception):
    def __init__(self, mensaje="El formato de año debe ser yyyy."):
        self.mensaje = mensaje
        super().__init__(self.mensaje)
    ...
    while True:
        ...
        if opcion == "1":
            try:
                ...
                print(e)
            except ErrorLibroDuplicado as e:
                print(e)
            except ErrorAñoInvalido as e:
                print(e)
